...
class PrivilegesController extends CrudController
{
    ...
    public function __construct() {
        $this->entity = "ZFAcl\Entity\Privilege";
        $this->service = "ZFAcl\Service\Privilege";
        $this->form = "ZFAcl\Form\Privilege";
    ...
    {
        $form = $this->getServiceLocator()->get('ZFAcl\Form\Privilege');
